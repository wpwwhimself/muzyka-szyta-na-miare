        ...
        <section>
            <div class="section-header">
                ...
                <div class="grid-2">
                    ...
                    <x-select name="contact_preference" label="Preferencja kontaktowa" :value="$client->contact_preference" :small="true" :options="$contact_preferences" />
                </div>
        </section>
        <section>
            <div class="section-header">
                ...
                <x-input type="text" name="password" label="Hasło" :value="$client->password" :small="true" :disabled="true" />
