<section id="offer">
    ...
    <div class="grid" role="locations" style="--col-count: 3;">
        ...
        @endforeach
        <em class="flex right center middle location-keywords">
...
<x-front.tabbed-section id="showcases" title="Z kim współpracuję" icon="disc">
    ...
    <div class="showcase-section flex down spaced hidden" data-mode="ViolArte">
        ...
        <div id="showcase-fbs">
            ...
            <iframe src="https://www.tiktok.com/player/v1/7688421933364350230" width="300" height="315" allow="autoplay; clipboard-write; encrypted-media; picture-in-picture; web-share" allowfullscreen></iframe>
            <iframe width="560" height="315" src="https://www.youtube.com/embed/8fzqi7btRPg?si=yCtMVhXPfiVZx7fY" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
        </div>
    </div>
    ...
    <div class="showcase-section flex down spaced hidden" data-mode="Ewelina Spławska">
        ...
        <div id="showcase-fbs">
            <iframe src="https://www.tiktok.com/player/v1/7673987355606289686" width="300" height="575" allow="autoplay; clipboard-write; encrypted-media; picture-in-picture; web-share" allowfullscreen></iframe>
