...
@section("title", "Zlecenie utworzone")

@section('content')

<h2>Zapytanie zostało pomyślnie przeniesione do nowej fazy.</h2>
...
@if ($status == 9)
    ...
    <h3 style="text-align: center;">{{ $request->user->password_actual }}</h3>
    <p>
